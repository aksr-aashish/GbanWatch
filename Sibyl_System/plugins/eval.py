...
@System.on(system_cmd(pattern=r"GbanWatch (exec|execute|x|ex)"))
async def run(event):
...
@System.on(system_cmd(pattern=r"GbanWatch (ev|eva|eval|py)"))
...
EXAMPLE - `!GbanWatch x print("OWO")`
Run code using **eval**
CMD - <ev or eva or eval or py> your code
EXAMPLE - `!GbanWatch eval 1 + 1`
"""
